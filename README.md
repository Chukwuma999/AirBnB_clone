...
| `update`  | `User.update('123', {'name' : 'Chukwuma999'})` | updates attribute of an object             |
| `destroy` | `User.destroy('123')`                         | destroys specified object                  |
| `show`    | `User.show('123')`                            | retrieve an object from a file or database |
| `all`     | `User.all()`                                  | display all objects in a class               |
| `count`   | `User.count()`                                | returns count of objects in the specified class|
| `quit`    | `quit`                                        | exits                                      |

#### Installation
```
git clone https://github.com/Chukwuma999/AirBnB_clone.git
cd AirBnB_clone
```
#### Usage
Interactive Mode
